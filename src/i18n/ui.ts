...
const en = {
  ...
  'home.nye.lead': 'Shanka Tribe plays the old year out and the new one in: a night of live music under the open sky at Ashramam Maidan, right up to the countdown over Ashtamudi.',
  'home.nye.headliner': 'Live on the lakeside stage · 20:30',
  'home.nye.headlinerName': 'Shanka Tribe',
  ...
  'home.nye.r4': 'Shanka Tribe, live by the lake',
  'home.nye.r5': 'Countdown on Ashtamudi, with Shanka Tribe',
...
const ml: Partial<Record<UIKey, string>> = {
  ...
  'home.nye.lead': 'Shanka Tribe ബാൻഡ് പഴയ വർഷത്തെ യാത്രയാക്കി പുതിയതിനെ വരവേൽക്കുന്നു: ആശ്രാമം മൈതാനത്ത് തുറന്ന ആകാശത്തിനു കീഴിൽ തത്സമയ സംഗീതം, അഷ്ടമുടിക്കു മീതെയുള്ള കൗണ്ട്ഡൗൺ വരെ.',
  ...
  'home.nye.r4': 'Shanka Tribe, കായലോരത്ത് തത്സമയം',
  'home.nye.r5': 'അഷ്ടമുടിയിൽ കൗണ്ട്ഡൗൺ, Shanka Tribe-നൊപ്പം',
